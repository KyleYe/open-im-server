...
In the OpenIM project, we use the unified logging package `github.com/KyleYe/open-im-tools/log` for logging to achieve efficient log management and analysis. This logging package supports structured logging formats, making it easier for developers to handle log information.
...
We use the `github.com/KyleYe/open-im-tools/errs` package for unified error handling and wrapping.
