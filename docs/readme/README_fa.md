...
اگر می‌خواهید در این مخزن Open-IM-Server مشارکت کنید، لطفاً [مستندات مشارکت‌کننده](https://github.com/KyleYe/open-im-server/blob/main/CONTRIBUTING.md) ما را بخوانید.

قبل از شروع، لطفاً مطمئن شوید که تغییرات شما مورد تقاضا هستند. بهترین کار برای آن این است که یک [بحث جدید](https://github.com/KyleYe/open-im-server/discussions/new/choose) یا [ارتباط اسلک](https://join.slack.com/t/openimsdk/shared_invite/zt-22720d66b-o_FvKxMTGXtcnnnHiMqe9Q) ایجاد کنید، یا اگر مشکلی پیدا کردید، ابتدا [آن را گزارش کنید](https://github.com/KyleYe/open-im-server/issues/new/choose).

- [مرجع OpenIM API](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/api.md)
- [OpenIM Bash Logging](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/bash-log.md)
- [OpenIM CI/CD Actions](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/cicd-actions.md)
- [کنوانسیون کد OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/code-conventions.md)
- [دستورالعمل های تعهد OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/commit.md)
- [راهنمای توسعه OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/development.md)
- [ساختار دایرکتوری OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/directory.md)
- [تنظیم محیط OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/environment.md)
- [مرجع کد خطا OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/error-code.md)
- [OpenIM Git Workflow](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/git-workflow.md)
- [راهنمای انتخاب گیلاس OpenIM Git](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/gitcherry-pick.md)
- [OpenIM GitHub Workflow](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/github-workflow.md)
- [استانداردهای کد OpenIM Go](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/go-code.md)
- [دستورالعمل های تصویر OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/images.md)
- [پیکربندی اولیه OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/init-config.md)
- [راهنمای نصب OpenIM Docker](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/install-docker.md)
- [نصب سیستم OpenIM Linux OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/install-openim-linux-system.md)
- [راهنمای توسعه OpenIM Linux](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/linux-development.md)
- [راهنمای اقدامات محلی OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/local-actions.md)
- [OpenIM Logging Conventions](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/logging.md)
- [استقرار آفلاین OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/offline-deployment.md)
- [OpenIM Protoc Tools](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/protoc-tools.md)
- [راهنمای تست OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/test.md)
...
- [ابزارهای OpenIM Script](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/util-scripts.md)
- [نسخه OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/version.md)
- [مدیریت استقرار باطن و نظارت](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/prometheus-grafana.md)
- [راهنمای استقرار توسعه دهنده مک برای OpenIM](https://github.com/KyleYe/open-im-server/tree/main/docs/contrib/mac-developer-deployment-guide.md)
...
صفحه [مطالعات موردی کاربر](https://github.com/OpenIMSDK/community/blob/main/ADOPTERS.md) ما را برای لیستی از کاربران پروژه بررسی کنید. از گذاشتن [نظر📝](https://github.com/KyleYe/open-im-server/issues/379) و به اشتراک گذاری مورد استفاده خود دریغ نکنید.

## :page_facing_up: مجوز

OpenIM تحت مجوز Apache 2.0 مجوز دارد. برای متن کامل مجوز به [LICENSE](https://github.com/KyleYe/open-im-server/tree/main/LICENSE) مراجعه کنید.

نشان‌واره OpenIM، شامل انواع و نسخه‌های متحرک آن، که در این مخزن [OpenIM](https://github.com/KyleYe/open-im-server) تحت فهرست‌های [assets/logo](./assets/logo) و [assets/logo-gif](assets/logo-gif) نمایش داده می‌شود، توسط قوانین حق چاپ محافظت می‌شود.
